...
export const login = data => fetch('/mhh/login', data, 'POST');
...
export const adminCount = () => fetch('/mhh/admin/count');

/**
 * 获取定位城市
 */

export const searchByDepartment = data => fetch('/mhh/queryBydepartment', data, "POST");
...
export const addProcessInfo = data => fetch('/api/addProcessInfo', data, 'POST');

/**
 * 添加商铺
 */

export const addConsultantInfo = data => fetch('/api/addConsultantInfo', data, 'POST');



export const addTechnicianInfo = data => fetch('/api/addTechnicianInfo', data, 'POST');

export const addComponentInfo = data => fetch('/api/addComponentInfo', data, 'POST');
...
export const addClue = data => fetch('/api/addClueInfo', data, 'POST');
